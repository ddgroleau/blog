...
function enjoyblog_scripts() {
    ...
    wp_enqueue_script( 'enjoyblog-index', get_template_directory_uri() . '/assets/js/index.js', array(), '20220524', true );                                       	
	wp_enqueue_script( 'enjoyblog-custom', get_template_directory_uri() . '/assets/js/jquery.custom.js', array(), '20220524', true );	
    ...
    wp_enqueue_style( 'enjoyblog-style', get_stylesheet_uri(), array(), '20220524' );   
	wp_enqueue_style( 'enjoyblog-responsive-style',   get_template_directory_uri() . '/responsive.css', array(), '20220524' );       
	wp_enqueue_style( 'font-awesome-style',   get_template_directory_uri() . '/assets/css/font-awesome.css', array(), '20220524' );       	
